...
const CandidateCard = ({ currentCandidate, removeFromStorage, }) => {
    ...
    return (<li className={styles["candidate-card"]}>
      <img src={currentCandidate.avatar_url} alt={`${currentCandidate.name || currentCandidate.login} avatar`} className={styles["candidate-avatar"]}/>
